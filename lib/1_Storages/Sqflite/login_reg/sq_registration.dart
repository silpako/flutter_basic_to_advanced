...
import 'package:flutter_basic_to_advanced/1_Storages/Sqflite/login_reg/sq_login.dart';
  ...
  Widget build(BuildContext context) {
    void registerUser(String name, String email, String password) async {
      var id = await SQL_Functions.addUser(
        ...
        email,
        password,
      ); // id that return when we add new users
      print(id);
      if (id != null) {
            ...
            children: [
              ...
              ElevatedButton(
                onPressed: () async {
                  ...
                  if (valid == true) {
                    var users =
                        await SQL_Functions.checkUser_already_registered(
                          email_cntrl.text,
                        );
                    ...
                    ScaffoldMessenger.of(context).showSnackBar(
                      SnackBar(content: Text("Please Verify All the Fields")),
                    );
                  }
                },
