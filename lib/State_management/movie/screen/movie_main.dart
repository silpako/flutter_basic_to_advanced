...
import 'package:flutter_basic_to_advanced/State_management/movie/screen/wishlist.dart';
...
class MovieMain extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: const Text("Moives")),
      body: Column(
        children: [
          ElevatedButton.icon(
                    ...
                    trailing: IconButton(
                      ...
                      onPressed: () {
                        if (!wishmovies.contains(currentMovie)) {
                          context.read<MovieProvider>().addtoWishList(
                            currentMovie,
                          );
                        } else {
                          context.read<MovieProvider>().removeFromWishList(
                            currentMovie,
                          );
                        }
                      },
