...
import 'package:flutter_basic_to_advanced/1_Storages/Sqflite/todo/db_function.dart';
...
class _MyToDoState extends State<MyToDo> {
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(backgroundColor: Colors.purple, title: const Text("ToDo")),
      body: isLoading
  ...
  // create and update task function
